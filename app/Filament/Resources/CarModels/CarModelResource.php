...
class CarModelResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Automobilių modelis';

    protected static ?string $pluralModelLabel = 'Automobilių modeliai';

    protected static ?string $navigationLabel = 'Modeliai';
